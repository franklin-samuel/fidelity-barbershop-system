...
a Github Workflow that does tests and get up our Docker Image to Docker Hub, then trigger a deploy hook to render that is looking for our Docker Hub and start a automatic deploy looking for our currently image.
